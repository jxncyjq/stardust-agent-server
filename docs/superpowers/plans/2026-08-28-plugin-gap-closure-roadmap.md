...
**当前基线**：P0 / P0.5 / P1 / P2-A4a / P2-A4b / P3-A5a / P3-A5b / P3-A5c / GUI 同意流 **全部已交付并合入 master**；`plugin_example/` 与参考手册已交付。本路线图的 **G1 / G2 / G3 / G5 / G6 / G7 已交付并合入 master**；**G4 拆成 a-d 四步，G4a/G4b/G4c/G4d 全部已交付**；插件工具**已接进每个任务的注册表**（`plans/2026-08-29-plugin-tools-reachable.md`），四个 seam 对 agent 自己的调用生效（见下）
...
| **D1 服务接缝** | 命名服务：按能力名依赖而不是按工具名。**已决策**（做命名服务 / 先到先得 / 唯一提供者），**D1a 已交付**，D1b（call_tool 的 service: 解析）待做 | G4a 的授权面 | 中 | 已拍板 |
