...
| 4 起 serve 看挂载日志 | 如预期 |
| 5 改一个字节再起一次 | 如预期 |
| 6 撤销一把正在用的钥匙，不重启 serve | **部分如预期**（+发现 C，本次唯一的实现缺陷；C 已修复，见下） |
| 7 写进计划 | 本节 |
